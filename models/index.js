...
Tracker.hasOne(Defect, { foreignKey: 'tracker_id' })
Defect.belongsTo(Tracker, { foreignKey: 'tracker_id' })
Warehouse.hasOne(Defect, { foreignKey: 'warehouse_id' })
Defect.belongsTo(Warehouse, { foreignKey: 'warehouse_id' })
